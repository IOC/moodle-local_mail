...
$string['assigntonewlabel'] = '加入到新标签...';
$string['attachments'] = '附件';
$string['attachnumber'] = '{$a} 个附件';
$string['bcc'] = '密送';
$string['bulkmessage'] = '给选择的用户发送一封邮件...';
$string['cancel'] = '取消';
$string['cannotcompose'] = '你没有选任何课程，不能创建邮件.';
$string['cc'] = '抄送';
$string['compose'] = '创建';
$string['continue'] = '继续';
$string['courses'] = '课程';
$string['cronduration'] = 'Cron持续时间';
$string['cronenabled'] = '开启Cron';
$string['cronstart'] = 'Cron 开始';
$string['cronstop'] = 'Cron 停止';
$string['delete'] = '删除';
$string['discard'] = '放弃';
$string['draft'] = '草稿';
$string['drafts'] = '草稿箱';
...
$string['errorinvalidcolor'] = '无效的颜色';
$string['filterbydate'] = '日期 (up to the day):';
$string['from'] = '从';
$string['inbox'] = '收件箱';
$string['invalidlabel'] = '无效的标签';
$string['invalidmessage'] = '无效的邮件';
$string['labeldeleteconfirm'] = '你确定要彻底删除标签 \'{$a}\'吗?';
$string['labelname'] = '名称';
$string['labelcolor'] = '颜色';
$string['labels'] = '标签';
$string['mail:addinstance'] = '添加一个新邮件';
$string['mail:usemail'] = '使用邮件';
$string['mailupdater'] = '邮件更新';
$string['markasread'] = '标识为已读';
$string['markasstarred'] = '标识为重要邮件';
$string['markasunread'] = '标识为未读';
$string['markasunstarred'] = '标识为非重点邮件';
...
$string['toomanyrecipients'] = '查找到太多的邮件';
$string['forward'] = '转发';
$string['save'] = '保存';
$string['send'] = '发送';
